...
<section class="about-container">
  <div class="about-hero">
    ...
    <p class="lede">
      Open Prompt turns posts into clean, readable pages that are easy to share, revisit, and pass
  ...
  <div class="about-section">
    ...
    <p class="muted">
      A good reading app should disappear behind the work. Open Prompt keeps the focus on the
  ...
  <div class="about-section">
    ...
    <p class="muted">
      Open Prompt avoids pushing readers into raw identifiers, implementation details, or cluttered
      layouts.
    </p>
  </div>
  ...
  <div class="about-section">
    <h2>Open Prompt is built around a few simple reading habits.</h2>
  ...
  <div class="about-section">
    <h3>Use Open Prompt when writing should feel linkable, legible, and easy to follow.</h3>
    <div class="definition-list">
      <div class="definition-row">
        <span>Readers</span>
  ...
  <div class="about-cta">
    ...
    <p class="lede" style="margin: 0;">
      Open Prompt keeps the experience focused on people and writing, not protocol trivia.
    </p>
    <div class="actions">
